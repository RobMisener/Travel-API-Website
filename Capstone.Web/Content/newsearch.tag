<newsearch>
    <div class="searchContainer">
        <input class="searchBox" type="text" name="place" onkeypress="{ keypress }" placeholder="enter a city" />
        ...
        <input id="enter" class="searchButton" name="search" type="button" onclick="{ search }" value="SEARCH" />
